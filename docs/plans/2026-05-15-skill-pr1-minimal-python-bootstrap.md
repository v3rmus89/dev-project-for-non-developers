...
- `requirements-dev.txt.tmpl` — pinned `ruff==0.15.12`, `pre-commit>=3.7,<5`, `pytest>=8.0,<9` (concrete versions match Acme's `/Users/sandeep/Desktop/Code/Acme/Telegram bot/requirements-dev.txt` — same toolchain on every generated project; closes Codex iter-6 finding #4)
...
| `shared/Makefile.review.tmpl` | derived from `/Users/sandeep/Desktop/Code/Acme/Telegram bot/Makefile` lines 66–115 | Three targets (codex, claude, preflight); reviewer-aware `PLAN_REVIEW_OUT` filename; `env -u` scrub list enumerated explicitly |
...
- `/Users/sandeep/Desktop/Code/Acme/Telegram bot/docs/plans/2026-05-15-dev-project-setup-skill.md` — the merged plan; subsystems A–F are defined there
- `/Users/sandeep/Desktop/Code/Acme/Telegram bot/Makefile` lines 66–115 — source of `Makefile.review.tmpl`'s `review-plan-by-codex` target
- `/Users/sandeep/Desktop/Code/Acme/Telegram bot/.github/workflows/claude-review.yml` — source of `shared/claude-review.yml.tmpl`
- `/Users/sandeep/Desktop/Code/Acme/Telegram bot/.github/pull_request_template.md` — source of `shared/pull_request_template.md.tmpl`
- `/Users/sandeep/Desktop/Code/Acme/Telegram bot/CLAUDE.md`, `AGENTS.md`, `CONTRIBUTING.md`, `BACKLOG.md`, `docs/plans/README.md` — sources of the corresponding `shared/*.tmpl` files
