...
| 4.5c | Claude (consistency self-check, round 3) | 2026-05-29 | doc-drift × 2 | folded | D1 Log had 4.5 before 4 again → reordered. D2 V-13.5 failure THREAD_MODE=undefined → THREAD_MODE=fresh. (Recurring log-ordering defect, same class as 3.5b/3.5; fixed in this round.) |
